...
/**
 * @file plugins/themes/libio/LibioThemePlugin.inc.php
 *
...
class LibioThemePlugin extends \PKP\plugins\ThemePlugin
{
    ...
    public function init()
    {
		...
		$this->addOption('typography', 'FieldOptions', [
			'type' => 'radio',
			'label' => __('plugins.themes.libio.option.typography.label'),
			'description' => __('plugins.themes.libio.option.typography.description'),
			'options' => [
				[
					'value' => 'notoSans',
					'label' => __('plugins.themes.libio.option.typography.notoSans'),
				],
				[
					'value' => 'notoSerif',
					'label' => __('plugins.themes.libio.option.typography.notoSerif'),
				],
				[
					'value' => 'notoSerif_notoSans',
					'label' => __('plugins.themes.libio.option.typography.notoSerif_notoSans'),
				],
				[
					'value' => 'notoSans_notoSerif',
					'label' => __('plugins.themes.libio.option.typography.notoSans_notoSerif'),
				],
				[
					'value' => 'lato',
					'label' => __('plugins.themes.libio.option.typography.lato'),
				],
				[
					'value' => 'lora',
					'label' => __('plugins.themes.libio.option.typography.lora'),
				],
				[
					'value' => 'lora_openSans',
					'label' => __('plugins.themes.libio.option.typography.lora_openSans'),
				],
			],
			'default' => 'notoSans',
		]);
		...
		$this->addOption('baseColour', 'FieldColor', [
			'label' => __('plugins.themes.libio.option.colour.label'),
			'description' => __('plugins.themes.libio.option.colour.description'),
			'default' => '#1E6292',
		]);
		...
		$this->addOption('showDescriptionInJournalIndex', 'FieldOptions', [
			'label' => __('manager.setup.contextSummary'),
				...
				[
					'value' => true,
					'label' => __('plugins.themes.libio.option.showDescriptionInJournalIndex.option'),
				],
			],
			'default' => false,
		]);
		$this->addOption('useHomepageImageAsHeader', 'FieldOptions', [
			'label' => __('plugins.themes.libio.option.useHomepageImageAsHeader.label'),
			'description' => __('plugins.themes.libio.option.useHomepageImageAsHeader.description'),
				'options' => [
				[
					'value' => true,
					'label' => __('plugins.themes.libio.option.useHomepageImageAsHeader.option')
				],
			],
			'default' => false,
		]);
